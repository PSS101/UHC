...
export default function Doctor({navigation}){
    return(
        ...
        <View styles={styles.container}>
            <Text
            style={{margin:20,fontWeight:'bold',fontSize:25}}>Welcome Doc</Text>
            ...
            <View style={styles.card}> 
                ...
                <View style={{marginLeft:10,flexShrink: 1}}>
                    <Text style={{margin:5,fontWeight:'bold',fontSize:15}}>New Doctor</Text>
                    <Text style={{color:'#898888'}}>Create your profile to get started</Text>
                </View>
            </View>
            </Pressable>
            
            <Pressable  onPress={()=>navigation.navigate('DoctorSignIn')}>
             <View style={styles.card}>
                <AntDesign  name="login" size={26} color="#10b981" backgroundColor={'#e1f6ef'} borderRadius={10} padding={15}/>
                <View style={{marginLeft:10,flexShrink: 1,}}>
                    <Text style={{margin:5,fontWeight:'bold',fontSize:15}}>Existing Doctor</Text>
